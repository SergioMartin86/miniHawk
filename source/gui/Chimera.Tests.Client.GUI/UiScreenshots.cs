	...
	public class UiScreenshots
	{
		...
		public void CacheManager()
		{
			...
			var items = new List<CacheItem>
			{
				...
				new() { Kind = CacheKind.CompiledCode, Label = "rpcs3", Core = "rpcs3", Detail = "e6bdd2b2", Path = @"C:\Users\you\AppData\Local\Chimera\CompiledCode\rpcs3\e6bdd2b2", Bytes = 1_073_741_824L, LastUsed = new DateTime(2026, 9, 5, 11, 27, 0), Locked = true },
